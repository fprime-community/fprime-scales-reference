...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Deployment_blockDrv::WARN, PingEntries::Deployment_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Deployment_tlmSend::WARN, PingEntries::Deployment_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Deployment_cmdDisp::WARN, PingEntries::Deployment_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Deployment_cmdSeq::WARN, PingEntries::Deployment_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Deployment_eventLogger::WARN, PingEntries::Deployment_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Deployment_fileDownlink::WARN, PingEntries::Deployment_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Deployment_fileManager::WARN, PingEntries::Deployment_fileManager::FATAL, "fileManager"},
    {PingEntries::Deployment_fileUplink::WARN, PingEntries::Deployment_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Deployment_prmDb::WARN, PingEntries::Deployment_prmDb::FATAL, "prmDb"},
