 ...
 */
namespace PingEntries {
namespace Deployment_blockDrv {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_tlmSend {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_cmdDisp {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_cmdSeq {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_eventLogger {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_fileDownlink {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_fileManager {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_fileUplink {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_prmDb {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_rateGroup1 {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_rateGroup2 {
enum { WARN = 3, FATAL = 5 };
}
namespace Deployment_rateGroup3 {
enum { WARN = 3, FATAL = 5 };
}
}  // namespace PingEntries
}  // namespace Deployment
